...
def classify_by_most_common(scheme, if_scheme_exists="replace", n_classifications_per_trx=3):
    ...
    predictions = clf.predict(x=df_trxs['description'], n=n_classifications_per_trx)
...
cli.add_command(classify_db_by_lookup_cli, name="by-lookup")
cli.add_command(classify_by_most_common_cli, name="by-most-common")
